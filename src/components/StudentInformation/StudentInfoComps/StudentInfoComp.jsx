...
export const StudentInfoComp = () => {
  ...
  const columns = [
...

    {
      ...
      cell: (row) => (
        <>
          <Link to={`/studentinfo/view/${row.id}`}>
    ...
    [...admittedStudentsData]?.filter((item) => {
      if (
        (item.Class.toLowerCase().replace(" ", "") ===
          ...
          +item.student_id.includes(searchFilter.toLowerCase())) &&
              ...
              <div className="d-flex py-2 px-3 align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center">
                    ...
                    <img
                      onClick={() => {
                        toastTL.current.show({
                          severity: "success",
                          summary: "Copied",
                          detail: "Student List Copy on your clipboard",
                          life: 1000,
                        });
                      }}
                      src={copy}
                  ...
                  <CSVLink data={extractCSVData()} filename="Student List.csv">
                    <img src={xls} className="theadicon mx-1" title="CSV" />
                  </CSVLink>
                  <img
