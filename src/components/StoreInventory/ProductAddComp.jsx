    ...
    <>
      <div className="content-body">
        ...
        <div className="d-flex py-2 px-3 border-b align-items-center">
          {tab == "add" ? (
            <>
              <p className="header-font">General Item Add</p>
            </>
          ) : (
            <>
              <p className="header-font">Edit General Item</p>
            </>
          )}
        </div>
          ...
          <div className="container-fluid">
            <div className="row px-1">
              {tab == "add" && (
                <>
                  <div className="col-lg-4 pt-2">
                    <form onSubmit={generalItemadd} id="form">
                      <div className="row">
              ...
              {tab == "edit" && (
                <>
                  <div className="col-lg-4 pt-2">
                    <form onSubmit={generalItemedit} id="form">
                      <div className="row">
                        <div className="col-lg-12 mb-2">
                          <label className="form-label label1">
                            Product Category
