    ...
    <>
      <div className="content-body">
        ...
        <div className="d-flex py-2 px-3 border-b align-items-center">
          <p className="header-font">Make Supplier Payment</p>
        </div>
