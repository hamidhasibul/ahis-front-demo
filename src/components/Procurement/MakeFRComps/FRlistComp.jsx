...
export const FRlistComp = () => {
  ...
  const getSPListData = () => {
    fetch(`${import.meta.env.VITE_SERVER}/getSupplyPaymentCountFR`, {
      method: "POST",
    })
      .then((res) => res.json())
      .then((res) => {
  ...
  const getSPListItemData = () => {
    ...
    data.append("fr_id", activeid);
    fetch(`${import.meta.env.VITE_SERVER}/getfundrequestInfo`, {
      method: "POST",
      body: data,
    })
      .then((res) => res.json())
  ...
  const approvel = () => {
    ...
    fetch(`${import.meta.env.VITE_SERVER}/UpdateFundRequestApprovel`, {
      method: "POST",
      body: data,
    })
      .then((res) => res.json())
  ...
  return (
    <div className="content-body">
      <div className="d-flex py-2 px-3 border-b align-items-center">
        <p className="header-font">Fund Request List</p>
      </div>
